...
//a
//Create transfer
exports.TransferRouter.post("/user/transfer", [isAuth_1.isAuth, validator_1.transferValidator.transfer], (0, utils_1.wrapAsync)(controller_1.transferController.createTransfer));
